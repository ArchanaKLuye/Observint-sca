...
define('Accessory.Model', [
    ...
    return SCModel.extend({
        ...
        get: function get(item) {
            var responseData = {};
            var it = nlapiLookupField('item', item.internalid, ['custitem_custom_productaccessories']);
            ...
            return { AccessoryData: AccessoryData };
        },
        getAccessory: function getData(id) {
            ...
            return _.map(results, function (result) {
                var data = {
                    itemid: result.getValue('itemid') || undefined,
                    salesdescription: result.getValue('salesdescription') || undefined,
                    internalid: result.getValue('internalid') || undefined,
                    imageurl: result.getValue('imageurl') || undefined
                };
                return data;
            });
        }
...
define('Accessories.ServiceController', [
    ...
    'SC.Models.Init',
    'underscore'
], function AccessoriesServiceController(AccessoryModel, ServiceController, Application, ModelsInit, _) {
    'use strict';
    return ServiceController.extend({
