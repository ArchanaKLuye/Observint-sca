...
define('CreditCard.View', [
    'SC.Configuration', 'CreditCard.Edit.Form.SecurityCode.View', 'creditcard.tpl', 'Backbone.CompositeView', 'Backbone.FormView', 'Backbone', 'underscore', 'Utils'
], function(
    Configuration, CreditCardEditFormSecurityCodeView, creditcard_tpl, BackboneCompositeView, BackboneFormView, Backbone, _
) {
    'use strict';
