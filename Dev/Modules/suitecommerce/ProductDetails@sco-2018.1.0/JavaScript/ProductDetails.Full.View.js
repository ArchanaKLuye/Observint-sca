...
define(
    'ProductDetails.Full.View', [
        'ProductDetails.Base.View', 'SC.Configuration', 'ProductDetails.Videos.View', 'ProductDetails.Specification.View', 'Accessories.View'
    ...
    function(
        ProductDetailsBaseView, Configuration, ProductDetailsVideosView, ProductDetailsSpecificationView, AccessoriesView
        ...
        return ProductDetailsBaseView.extend({
            ...
            childViews: _.extend({}, ProductDetailsBaseView.prototype.childViews, {
                    ...
                    'Product.Details': function() {
                        return new ProductDetailsVideosView({
                            model: this.model
                        });
                    },
                    'Product.Specification': function() {
                        return new ProductDetailsSpecificationView({
                            model: this.model
                        });
                    },
