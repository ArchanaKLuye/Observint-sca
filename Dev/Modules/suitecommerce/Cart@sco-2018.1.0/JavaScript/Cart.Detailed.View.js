...
define('Cart.Detailed.View', ['Backbone.CompositeView', 'GlobalViews.Message.View', 'Backbone.CollectionView', 'Backbone.FormView'
    ...
    , 'Cart.Lines.View', 'Cart.Lines.Free.View', 'Cart.Promocode.Notifications.View'

    , 'Cart.Summary.View', 'Cart.Item.Summary.View', 'Cart.Item.Actions.View', 'SC.Configuration'

    , 'cart_detailed.tpl', 'cart_lines_free.tpl'
    ...
    , CartLinesView, CartLinesFreeView, CartPromocodeNotifications

    , CartSummaryView, CartItemSummaryView, CartItemActionsView, Configuration

    , cart_detailed_tpl, cart_lines_free_tpl
    ...
    return Backbone.View.extend({
        ...
        childViews: {
            ...
            'FreeGift.Info': function() {
                var message, free_gifts = _.filter(this.model.get('lines').models || [], function(line) { return line.get('free_gift') === true; });
