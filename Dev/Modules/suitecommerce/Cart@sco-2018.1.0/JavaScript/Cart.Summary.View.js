...
define(
    'Cart.Summary.View', [
        'SC.Configuration', 'Cart.PromocodeForm.View', 'Cart.Item.Summary.View', 'Backbone.CompositeView', 'Backbone.CollectionView', 'GlobalViews.FormatPaymentMethod.View', 'Profile.Model', 'Cart.Promocode.List.View', 'Session'
    ...
    function(
        Configuration, CartPromocodeFormView, CartItemSummaryView, BackboneCompositeView, BackboneCollectionView, GlobalViewsFormatPaymentMethodView, ProfileModel, CartPromocodeListView, Session
