...
define(
    'Cart.Component', [
        'ICart.Component', 'LiveOrder.Model', 'LiveOrder.Line.Model', 'Transaction.Paymentmethod.Model', 'Utils'

        , 'Backbone', 'jQuery', 'underscore'
    ],
    function(
        ICartComponent, LiveOrderModel, LiveOrderLineModel, TransactionPaymentmethodModel, Utils
