...
//@module Cart
define('Cart.Item.Summary.View', ['Cart.Promocode.List.Item.View', 'Cart.Promocode.Reason.View', 'Backbone.CompositeView', 'Backbone.CollectionView', 'Profile.Model'

    , 'cart_item_summary.tpl'

    , 'Backbone', 'underscore'
], function(
    CartPromocodeListItemView, CartPromocodeReasonView, BackboneCompositeView, BackboneCollectionView, ProfileModel
