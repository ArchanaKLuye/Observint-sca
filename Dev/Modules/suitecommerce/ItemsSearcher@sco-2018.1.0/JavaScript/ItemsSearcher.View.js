...
define(
    'ItemsSearcher.View', [
        'ItemsSearcher.Utils', 'ItemsSearcher.Collection', 'ItemsSearcher.Item.View', 'PluginContainer'
    ...
    function(
        ItemsSearcherUtils, ItemsSearcherCollection, ItemsSearcherItemView, PluginContainer
        ...
        var ItemsSearcherView = Backbone.View.extend({
            ...
            defaultOptions: {
                ...
                placeholderLabel: _('Search Products...').translate()
