...
define(
    'Header.Menu.MyAccount.View', [
        'SC.Configuration', 'header_menu_myaccount.tpl', 'Backbone', 'underscore', 'jQuery', 'ProductList.Utils'
    ],
    function(
        Configuration, header_menu_myaccount_tpl, Backbone, _, jQuery, ProductListUtils
    ) {
        'use strict';
