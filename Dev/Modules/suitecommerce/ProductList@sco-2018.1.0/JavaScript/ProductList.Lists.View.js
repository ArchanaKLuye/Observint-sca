	...
	)
{
	...
	,	events:
		...
		,	sortOptions: [
			...
			,	sort: function ()
				{console.log("this in list",this);
					...
					{console.log("hi");
						var milli_inv_one = invoiceOne.get('lastmodifieddate') || 0
						,	milli_inv_two = invoiceTwo.get('lastmodifieddate') || 0;

						/*milli_inv_one =
						milli_inv_two =*/
						console.log("invoiceOne",invoiceOne);
						console.log("milli_inv_one",milli_inv_one);
		...
		,	{
					value: 'test' 
				,	name: _('Test').translate()
				,	sort: function ()
					{console.log("this in list test",this);
						return this.models.sort(function (invoiceOne, invoiceTwo)
						{
							var milli_inv_one = invoiceOne.get('trandate') || 0
							,	milli_inv_two = invoiceTwo.get('trandate') || 0;
							...
							return invoiceOne.get('internalid') < invoiceTwo.get('internalid') ? -1 : 1;
						});
					}
				}
		]
