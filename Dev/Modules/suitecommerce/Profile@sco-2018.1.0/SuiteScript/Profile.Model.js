	...
	,	update: function (data)
		{
			...
			if(data.ext !== '')
			{
			data.phone = data.countryCode1+" "+data.phone+"x"+data.ext;
			}
			else{
				data.phone = data.countryCode1+" "+data.phone;
			}
			data.fax = data.countryCode2+" "+data.fax;
			data.altphone = data.countryCode3+" "+data.altphone;
