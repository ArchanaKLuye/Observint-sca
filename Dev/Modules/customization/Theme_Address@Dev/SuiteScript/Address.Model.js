	...
	)
{
	...
	/*,	setFaxField: function (id, data)
		{console.log("data in address model setFaxField start",data);
			data = this.unwrapAddressee(data);
			// validate the model
			this.validate(data);
			data.internalid = id;
			console.log("data in address model setFaxField end",data);
			return ModelsInit.customer.updateProfile({
				internalid : data.internalid,
				customfields: {
                   	"custrecord_fax":data.fax                 
                   }     
