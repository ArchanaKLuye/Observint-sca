	...
	)
{
	...
	,	getContext: function ()
		{   
			var itemMsrp = this.model.get('item').get('pricelevel10_formatted');
            ...
            var compareprice = price_container_object.compare_price_formatted;
            var rateformatted= this.model.get('rate_formatted');
            if(compareprice > rateformatted)
            {
