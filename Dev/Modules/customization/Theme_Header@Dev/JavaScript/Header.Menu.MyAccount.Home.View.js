...
// @module Header
define(
    'Header.Menu.MyAccount.Home.View', [
        'SC.Configuration', 'header_menu_myaccount_home.tpl', 'Backbone', 'underscore', 'jQuery', 'ProductList.Utils'
    ],
    function(
        Configuration, header_menu_myaccount_home_tpl, Backbone, _, jQuery, ProductListUtils
    ) {
        'use strict';
        ...
        return Backbone.View.extend({
            ...
            template: header_menu_myaccount_home_tpl
            ...
            getContext: function() {
                ...
                if (this.product_list_collection) {
                    ...
                    this.product_list_collection.each(function(product_list) {
                        var test = product_list.get('items');
                        t = t + test.length;
                    });
                }
