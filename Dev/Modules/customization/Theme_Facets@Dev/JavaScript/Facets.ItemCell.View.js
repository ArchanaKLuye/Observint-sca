...
define(
    'Facets.ItemCell.View', [
        'ProductViews.Price.View', 'ProductLine.Stock.View', 'Product.Model', 'GlobalViews.StarRating.View', 'Cart.QuickAddToCart.View', 'ProductViews.Option.View', 'ProductLine.StockDescription.View', 'SC.Configuration', 'Utils'

        , 'Backbone', 'Backbone.CompositeView', 'Backbone.CollectionView', 'underscore'
    ],
    function(
        ProductViewsPriceView, ProductLineStockView, ProductModel, GlobalViewsStarRating, CartQuickAddToCartView, ProductViewsOptionView, ProductLineStockDescriptionView, Configuration, Utils

        , Backbone, BackboneCompositeView, BackboneCollectionView, _
    ) {
        'use strict';
            ...
            getContext: function() {
                ...
                return {
                    ...
                    sku: this.model.getSku()
                        ...
                        ,
                    keyfeatures: this.model.getkeyfeatures()
                        ,
                    itemtopname: this.model.getitemtopname()
                        ,
