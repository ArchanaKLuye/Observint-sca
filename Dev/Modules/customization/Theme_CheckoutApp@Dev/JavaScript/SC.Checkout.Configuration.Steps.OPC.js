	...
	)
{
	...
	return [
		...
		,	steps: [
				{
					url: 'opc'
				,	continueButtonLabel: function () { return this.wizard && this.wizard.isExternalCheckout() ? _('Continue to External Payment').translate() : _('Submit Order').translate(); }
				...
				,	modules: [
						...
						//,	[OrderWizardModuleTitle, {title: _('BILLING ADDRESS').translate(), exclude_on_skip_step: true, isActive: function() {return this.wizard.model.shippingAddressIsRequired();}}]

						,	[OrderWizardModuleAddressBilling,address_opc_options]
						...
						,	OrderWizardModuleMultiShipToEnableLink
						,	[OrderWizardModuleAddressShipping, {enable_same_as: function () { return !this.wizard.model.get('ismultishipto') && this.wizard.model.shippingAddressIsRequired();}}]

						//,	[OrderWizardModuleTitle, {title: _('SHIPPING METHOD').translate(), exclude_on_skip_step: true, isActive: function() {return this.wizard.model.shippingAddressIsRequired();}}]
						,	[OrderWizardModuleShipmethod, delivery_method_opc_options]

						//,	[OrderWizardModuleTitle, {title: _('PAYMENT METHOD').translate()}]
						,	[OrderWizardModulePaymentMethodGiftCertificates]
						//,	OrderWizardModulePaymentMethodPurchaseNumber
