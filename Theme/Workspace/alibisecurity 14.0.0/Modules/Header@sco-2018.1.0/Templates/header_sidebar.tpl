<div class="header-sidebar-wrapper">
    ...
    <div class="header-sidebar-menu-wrapper" data-type="header-sidebar-menu">
        <ul class="header-sidebar-menu">
            ...
            {{/if}}
            <!-- <li class="header-sidebar-menu-myaccount" data-view="Header.Menu.MyAccount"></li> -->
            <li class="mob-sidebar" data-view="QuickOrderHeaderLink"></li>
            <li class="mob-sidebar" data-view="RequestQuoteWizardHeaderLink"></li>
            <li class="mob-sidebar" data-view="StoreLocatorHeaderLink"></li>
        </ul>
    </div>
    {{#if showExtendedMenu}}
