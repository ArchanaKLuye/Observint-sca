...
<div class="facets-faceted-navigation-item-facet-group" id="{{htmlId}}" data-type="rendered-facet" data-facet-id="{{facetId}}">
    ...
    {{else}}
    <a href="#" class="facets-faceted-navigation-item-facet-group-expander collapsed" id="{{htmlId}}" data-toggle="collapse" data-type="collapse" title="{{facetDisplayName}}">
					<i class="facets-faceted-navigation-item-facet-group-expander-icon" id="b{{htmlId}}"></i>
    ...
    {{/if}}
    {{/if}}
    <div class="{{#if isCollapsed}} collapse {{else}} collapse in {{/if}} facets-faceted-navigation-item-facet-group-wrappe" id="a{{htmlId}}">
...
<script>
$(function() {
    if ($(".facets-faceted-navigation-item-facet-group").length > 0) {
        $(".facets-faceted-navigation-item-facet-group").click(function() {
