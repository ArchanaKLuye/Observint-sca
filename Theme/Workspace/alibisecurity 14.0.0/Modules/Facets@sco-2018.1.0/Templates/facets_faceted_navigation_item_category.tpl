		...
		<div class="{{#if isCollapsed}} collapse {{else}} collapse in {{/if}} facets-faceted-navigation-item-category-facet-group-wrapper">
			<div class="facets-faceted-navigation-item-category-facet-group-content">
				...
				{{#if showExtraValues}}
					...
					<div class="facets-faceted-navigation-item-category-optionlist-extra-wrapper" style="display: none;">
...
<script>
	$(function(){
		if($(".facets-faceted-navigation-item-category-optionlist-extra-button").length>0){
$(".facets-faceted-navigation-item-category-optionlist-extra-button").click();
/*$(".facets-faceted-navigation-item-category-optionlist-extra-wrapper").hide();*/
}
	});
</script>
