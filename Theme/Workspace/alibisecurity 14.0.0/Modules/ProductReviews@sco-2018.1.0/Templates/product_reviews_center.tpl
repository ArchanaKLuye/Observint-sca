			...
			{{else}}
				<div class="product-reviews-center-container">
					<div class="product-reviews-center-container-header">
						...
						<p class="product-reviews-center-container-header-description">{{translate 'Be the first to'}}</p> <a href="{{itemUrl}}/newReview" class="product-reviews-center-container-button">{{translate 'Write a Review'}}</a>
					</div>
				</div>
			{{/if}}
		</div>
