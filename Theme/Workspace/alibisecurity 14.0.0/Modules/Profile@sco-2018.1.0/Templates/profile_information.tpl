		...
		<!-- <form class="contact_info"> -->
			<fieldset>
				...
				{{#if isCompanyAndShowCompanyField}}
					...
					<div class="profileinformation-contact-name">{{companyName}}</div>
				{{/if}}

				
				<div class="profileinformation-contact-address">
				<!-- <p>{{fullname}}</p> -->
				<p> 
				...
				<div class="profileinformation-contact-phone-value"><span class="profileinformation-contact-phone">Mobile: </span>{{phone}}</div>
				...
				<div class="profileinformation-contact-email-value"><span class="profileinformation-contact-phone">Email: </span>{{email}}</div>
