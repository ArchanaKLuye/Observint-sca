<div class="product-views-price">
    ...
    <small class="product-views-price-old">YourPrice :
						{{ yourPriceFormatted}}
					</small>
    {{#if showComparePrice}}
    ...
    <span class="product-views-price-exact" itemprop="offers" itemscope itemtype="https://schema.org/Offer">
				...
				{{#if showComparePrice}}
					<small class="product-views-price-old">MSRP :
						{{ comparePriceFormatted}}
					</small>
					{{else}}
					<small class="product-views-price-old" style="color: white">MSRP</small>
				...
				<div>
				<span class="product-views-price-lead" itemprop="price" data-rate="{{price}}">Your Price :
					{{priceFormatted}} 
				</span>
    <!-- {{#if notsalePrice}}	
						<span class="abc">
							{{#if issavingpercent}}
							<span class="savings-yourprice" style="display: inline-block;">(Save {{savingpercent}}% / ${{savings}})</span>
							{{else}}
							<span class="savings" style="display: none;">(Save {{savingpercent}} / ${{savings}})</span>
							{{/if}}
						</span>
					{{/if}} -->
</div>
...
<div>
    <small class="product-views-price-old1">Sale Price :
					{{ salePriceFormatted}} 
				</small>
    {{#if issavingpercent}}
    <span class="savings-saleprice" style="display: inline-block;">(Save {{savingpercent}}% / ${{savings}})</span>
    {{else}}
    <span class="savings" style="display: none;">(Save {{savingpercent}} / ${{savings}})</span>
    {{/if}}
</div>
...
<div class="product-views-price-login-to-see-prices-highlighted">
    <p class="product-views-price-message">
        {{translate 'Please <a href="$(0)" data-navigation="ignore-click" style="color: #00a7ce;">log in</a> to see price or purchase this item' urlLogin}}
    </p>
</div>
{{else}}
<div class="product-views-price-login-to-see-prices">
    <p class="product-views-price-message">
        {{translate '<a href="$(0)" data-navigation="ignore-click" style="color: #00a7ce;">Log in</a> to see price' urlLogin}}
    </p>
</div>
{{/if}}
{{/if}}
