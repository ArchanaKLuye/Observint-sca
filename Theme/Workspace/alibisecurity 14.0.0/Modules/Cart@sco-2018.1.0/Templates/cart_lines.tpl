<div id="{{lineId}}" data-item-id="{{itemId}}" data-type="order-item" class="{{#if showGeneralClass}} {{generalClass}} {{/if}} cart-lines-row">
	...
	<div class="cart-lines-table-middle col-lg-9">

		<div class="cart-lines-name col-lg-12">
		{{#if isNavigable}}
		<div class="cart-lines-product-details">	<a {{{linkAttributes}}} class="cart-lines-name-link">
				{{item._name}}
			</a>
			<div data-view="Item.Sku"></div>
				  
			<div class="cart-lines-price">
			<!-- <span class="cart-lines-price-label">{{translate 'Sale Price :'}}</span> -->
			<span class="cart-lines-price-label"data-view="Item.Price"></span>
		    </div>
		</div>
		{{else}}
...
<div class="line-border-cart"></div>
