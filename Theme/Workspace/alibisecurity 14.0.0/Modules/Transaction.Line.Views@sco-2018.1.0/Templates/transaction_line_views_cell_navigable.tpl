<tr class="transaction-line-views-cell-navigable {{cellClassName}} item-{{itemId}}" data-id="{{itemId}} col-lg-12 " data-item-type="{{itemType}}">
	<td class="transaction-line-views-cell-navigable-item-image col-lg-2" name="item-image">
		{{#if isFreeGift}}
	...
	<td class="transaction-line-views-cell-navigable-details col-lg-7" name="item-details">
	...
	<td class="transaction-line-views-cell-navigable-item-quantity col-lg-3" name="item-quantity">
		<p>
			<span class="transaction-line-views-cell-navigable-item-quantity-value">{{quantity}}</span>
			<span class="transaction-line-views-cell-navigable-item-quantity-label" style="padding-left: 3px;">{{translate 'Qty'}} </span>
	...
	<!-- <td class="transaction-line-views-cell-navigable-item-quantity" name="item-quantity">
		<p>
			<span class="transaction-line-views-cell-navigable-item-quantity-value">{{quantity}}</span>
			<span class="transaction-line-views-cell-navigable-item-quantity-label">{{translate 'Qty'}} </span>
