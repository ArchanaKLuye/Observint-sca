<div class="product-details-quickview">
    ...
    <div class="product-details-quickview-details">
        <h1 class="product-details-quickview-item-name" itemprop="name">{{pageHeader}}</h1> {{#if isItemProperlyConfigured}}
        <div data-view="Product.Sku"></div>
        <div class="product-details-quickview-rating-details">
            <div class="product-details-full-rating" data-view="Global.StarRating"></div>
          <!--   <div class="product-details-quickview-review-details" data-view="ProductReviews.Center"></div> -->
        </div>
        <div class="product-details-stock-info" data-view="Product.Stock.Info"></div>
    </div>
    {{/if}}
  <!--   <a class="product-details-quickview-full-details" data-action="go-to-fullview" data-touchpoint="home" data-name="view-full-details" data-hashtag="#{{itemUrl}}" href="{{itemUrl}}">
    ...
    <div class="product-details-quickview-main">
        ...
        <form id="product-details-quickview-form" data-action="submit-form" method="POST">
            ...
            <div class="product-details-quickview-pricing" data-view="Product.Price"></div>
            <div data-view="Quantity.Pricing"></div>
            {{#if isPriceEnabled}}
            <div class="product-details-quickview-section">
            <div class="product-details-item-counter" data-view="Quantity"></div>
