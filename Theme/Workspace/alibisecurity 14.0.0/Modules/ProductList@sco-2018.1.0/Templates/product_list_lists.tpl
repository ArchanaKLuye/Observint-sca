...
<section class="product-list-lists">
	...
	<div class="product-list-lists-header-main">
		<header class="product-list-lists-header">
			<div class="product-list-lists-title">{{translate 'MY LISTS'}}</div>
		</header>
		{{#unless isSingleList}}
			<!-- <button class="product-list-lists-button-add" data-action="add-list">{{translate 'Create New List'}}</button> -->
			<div class="product-list-lists-button-add" data-action="add-list">{{translate 'Create New List'}}</div>
		{{/unless}}
