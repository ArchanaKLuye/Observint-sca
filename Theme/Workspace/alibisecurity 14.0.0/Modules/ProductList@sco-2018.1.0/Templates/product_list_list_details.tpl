<div class="product-list-list-details-wrapper"  data-product-list-id="{{internalId}}" data-id="{{internalId}}">
<div class="product-list-list-details-wrapper2">
<div class="product-list-list-details-wrapper3" data-action="navigate" data-product-list-id="{{internalId}}" data-id="{{internalId}}">
	<div class="product-list-list-details-main">
		...
		<p class="product-list-list-details-item-count-label">
			{{#if hasItems}}
	...
	<div class="product-list-list-details-info">
		...
		{{#if hasListDescription}}
			<p class="product-list-list-details-description" style="display: none;">
	...
	<div class="product-list-list-details-actions">
		...
		<button data-action="add-to-cart" class="product-list-lists-button-add-to-cart" {{#unless isAvailableForCart}}disabled{{/unless}}>{{translate 'Add List to Cart'}}</button>

		{{#unless isTypePredefined}}
			<div class="product-list-list-details-button-group" style="display: none;">
...
<hr class="product-list-list-details-divider">
<div class="product-list-list-details-remove" data-action="delete-list-custom">REMOVE</div>
</div>
</div>
