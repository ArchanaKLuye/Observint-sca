<form action="#" class="product-list-new">
	...
	{{/if}}
		...
		<div data-validation="control-group">
			<label for="product-list-new-name" class="product-list-new-form-label">
				...
				{{else}}
					{{translate '<small class="product-list-new-form-required">*</small>List Name '}}
				{{/if}}
			</label>
			<div class="product-list-new-form-controls"  data-validation="control">
				<input id="product-list-new-name" type="text" name="name" data-action="prevent-enter" class="product-list-new-form-input" value="{{#if isEdit}}{{name}}{{/if}}">
			</div>
		</div>
		...
		<div class="product-list-new-form-controls-group" data-validation="control-group">
			...
			<div class="product-list-new-form-controls"  data-validation="control">
				<textarea id="product-list-new-description" class="product-list-new-form-textarea" name="description">{{#if isEdit}}{{description}}{{/if}}</textarea>
			</div>
		</div>
	...
	<div class="{{#if inModal}}product-list-new-modal-footer{{/if}} product-list-new-form-controls-group">
		...
		<button type="submit" class="product-list-new-form-submit">
			{{#if isEdit}}{{translate 'SAVE'}}{{else}}{{translate 'CREATE'}}{{/if}}
		</button>
		{{#if inModal}}
			<button class="product-list-new-form-cancel" data-dismiss="modal" style="display: none;">{{translate 'Cancel'}}</button>
		{{/if}}
	</div>
</form>
